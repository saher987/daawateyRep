...
// matching flags/comment in Login.jsx (this file's email/password form
// had no gating at all before this — Login.jsx's VITE_ALLOW_EMAIL_AUTH
// check was never ported here). Kept in sync between the two files
